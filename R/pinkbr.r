#' Pink salmon data from the Broughton Archipelago, British Columbia,
#' Canada from Krkosek et al. (2011) PNAS.
#'
#' These data represent pink salmon recruits for even years in the
#' Broughton Archipelago, BC, Canada. They are available in the
#' supplementary material of Krkosek et al. (2011). There were
#' originally provided by Fisheries and Oceans Canada. Column headers
#' denote river names.
#'
#' @name pinkbr
#' @docType data
